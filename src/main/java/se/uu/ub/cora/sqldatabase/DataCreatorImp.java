...
public class DataCreatorImp implements DataCreator {

	private SqlConnectionProvider sqlConnectionProvider;

	public static DataCreator usingSqlConnectionProvider(
			SqlConnectionProvider sqlConnectionProvider) {
		return new DataCreatorImp(sqlConnectionProvider);
	}

	private DataCreatorImp(SqlConnectionProvider sqlConnectionProvider) {
