...
public class SqlStorageException extends RuntimeException {
	...
	public SqlStorageException(String message, Exception exception) {
	...
	public static SqlStorageException withMessageAndException(String message, Exception exception) {
		return new SqlStorageException(message, exception);
	}
