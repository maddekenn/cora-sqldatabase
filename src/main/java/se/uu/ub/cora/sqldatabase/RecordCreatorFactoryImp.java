...
public class RecordCreatorFactoryImp implements RecordCreatorFactory {

	private SqlConnectionProvider sqlConnectionProvider;

	private RecordCreatorFactoryImp(SqlConnectionProvider connectionProvider) {
	...
	public RecordCreator factor() {
		...
		return new RecordCreatorImp(dataUpdater);
	}
